        ...
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">                
                ...
                <ul aria-expanded="false" >
                    <li><a href="{{route('members.all')}}">Users List</a></li>
                    <li><a data-bs-toggle="offcanvas" href="#offcanvasExample"
                        role="button" aria-controls="offcanvasExample">Add User</a></li>
                </ul>
            </li>
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">                
                <div class="menu-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 448 512"><path d="M0 64C0 28.7 28.7 0 64 0H384c35.3 0 64 28.7 64 64V448c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V64zM256 448a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zM384 64H64V384H384V64z"/></svg>
                </div>	
                <span class="nav-text">EnerTrack</span>
                </a>
                <ul aria-expanded="false" class="left mm-collapse">
                    <li><a href="{{route('monitoring')}}">Monitoring</a></li>
                    <li><a href="{{route('controlling')}}">Controlling</a></li>
                </ul>
            </li>       
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">                
                <div class="menu-icon">
                ...
                <ul aria-expanded="false" class="left mm-collapse">
                    <li><a href="{{url('/ac')}}">Data AC</a></li>
                    <li><a href="{{url('/kegiatan')}}">Data Kegiatan</a></li>
                </ul>
            </li>

            <li class=""><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                <div class="menu-icon">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
