...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xl-9 mx-auto">
            ...
            <a href="{{ url('/ac') }}" class="btn btn-danger btn-sm mt-3 mb-2"><i class='bx bx-arrow-back'></i> Back</a>
                    ...
                    <div class="p-4 border rounded">
                        <form action="{{ url('/ac/create') }}" method="post" class="row g-3 needs-validation">
                            ...
                            <div class="col-md-4">
                                ...
                                @enderror"
                                    name="tgl_pemasangan" id="date-format" value="{{ old('tgl_pemasangan') }}">
                            ...
                            <div class="col-md-4">
                                <label for="tgl_maintenance" class="form-label">Tanggal Maintenance
                                    <small>(optional)</small></label>
                                <input
                                    class="datepicker-default picker__input picker__input--active picker__input--target form-control @error('tgl_maintenance') is-invalid
                                @enderror"
